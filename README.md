...
- PIN 기반 클라이언트 등록 인증
- Long-poll 방식 실시간 명령 전달 (30초 timeout, 0.5초 확인 주기)
...
**언어 설정이 적용 안 됨**
클라이언트 로그(`C:\ProgramData\WCMS\logs\client.log`)에서 언어 팩 설치 결과를 확인하세요. 언어 팩 설치는 최대 30분 소요될 수 있으며, 설치 완료 후 재로그인 시 적용됩니다.
