...
- **현재 작업**: v0.9.0 계획 수립 완료.
- **다음 목표**: **v0.9.0 개발 시작** (HTTPS, 보안 헤더, robots.txt)
...
```markdown
현재 WCMS v0.8.8 버전입니다.
다음 목표는 v0.9.0 (서버 보안 강화)입니다.
- HTTPS 지원 (Let's Encrypt)
- 보안 헤더 적용 (Flask-Talisman)
- robots.txt 생성
- 취약점 점검 자동화 (GitHub Actions)
```
